...
SMFAjax.ajax = function(url, settings) {
	...
	if (settings.method === 'POST') {
		...
		if (isContentJson) {
			params.URL += '?' + formUrlEncoded(JSON.stringify(settings.data));
		} else {
...
SMFAjax.get = function(url, data, success, dataType, contentType) {
...
SMFAjax.getJSONViaJSON = function(url, data, success) {
	SMFAjax.get(url, data, success, 'json', 'json');
};

SMFAjax.getViaJSON = function(url, data, success) {
	SMFAjax.get(url, data, success, null, 'json');
};
